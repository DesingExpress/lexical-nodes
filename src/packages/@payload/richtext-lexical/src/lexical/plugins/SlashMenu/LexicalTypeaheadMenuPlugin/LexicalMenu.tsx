...
function getFullMatchOffset(
  ...
  for (let i = triggerOffset; i <= entryText.length; i++) {
    if (
      documentText.substring(documentText.length - i) ===
      entryText.substring(0, i)
    ) {
      triggerOffset = i;
    }
  }
        ...
        (payload) => {
          ...
          if (groups !== null && groups.length && selectedItemKey !== null) {
            ...
            const newSelectedIndex =
              selectedIndex !== allItems.length - 1 ? selectedIndex + 1 : 0;
      ...
      editor.registerCommand<KeyboardEvent>(
        ...
        (payload) => {
          ...
          if (groups !== null && groups.length && selectedItemKey !== null) {
            ...
            const newSelectedIndex =
              selectedIndex !== 0 ? selectedIndex - 1 : allItems.length - 1;
...
export function useMenuAnchorRef(
  ...
  const positionMenu = useCallback(() => {
    if (anchorElementRef.current === null || window.parent === undefined) {
      return;
    }
    const rootElement = editor.getRootElement();
    ...
    if (rootElement !== null && resolution !== null) {
      ...
      if (menuEle !== null) {
        ...
        const wouldGoOffBottomOfScreen =
          rawTop + menuHeight + VERTICAL_OFFSET > window.innerHeight;
        ...
        if (wouldGoOffBottomOfScreen && !wouldGoOffTopOfScreen) {
          ...
          containerDiv.style.top = `${
            top + window.scrollY + VERTICAL_OFFSET
          }px`;
        }
      }
